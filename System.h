...
public:
    ...
    // Reprojection error monitoring methods
    // 重投影误差监控方法
    bool CheckReprojectionError();
    ReprojectionErrorMonitor::ErrorStats GetReprojectionErrorStats();
...
private:
    ...
    // 触发快速位姿优化
    void TriggerFastPoseOptimization();
    
    // Update keyframe poses after optimization
    // 优化后更新关键帧位姿
    void UpdateKeyFramePoses(const std::vector<KeyFrame*>& vpKeyFrames);
...
private:
    ...
    // Reprojection error monitor for dynamic analysis
    ReprojectionErrorMonitor* mpReprojectionErrorMonitor;
